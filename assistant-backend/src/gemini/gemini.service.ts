...
export class GeminiService {
  ...
  async chatAboutStudies(question: string) {
    const systemPrompt = `
      You are a helpful study assistant chatbot. Your role is to provide guidance and answers to questions about education, studying, and academic topics.
      ...
      If the question is not related to education or studying, politely redirect the user to ask education-related questions.
